                ...
                <div class="space-y-20">
                        ...
                        <div class="flex flex-wrap md:flex-nowrap items-center mb-3 py-1.5 whitespace-nowrap">
                            <div class="min-w-0 flex items-center">
                                <h2 class="font-medium text-gray-900 truncate">
                                    <span class="mr-1">With progress bars</span>
                                </h2>
                    ...
                    <section aria-labelledby="heading-04740945117f4ec46b10f866630a6347">
                        <div class="flex flex-wrap md:flex-nowrap items-center mb-3 py-1.5 whitespace-nowrap">
                            <div class="min-w-0 flex items-center">
                                <h2 class="font-medium text-gray-900 truncate">
                                    <span class="mr-1">With large images and progress bars</span>
                                </h2>
                                <span class="flex-none uppercase bg-gray-200 text-gray-600 text-xs tracking-wide font-semibold px-2 py-1 rounded-md ml-3">
                                    PNG Preview
                                </span>
                        ...
                        <div class="rounded-lg ring-1 ring-gray-900 ring-opacity-5 overflow-hidden bg-white">
                            <img class="sm:hidden w-full h-auto" loading="lazy" src="img/v2/ecommerce/sm/order-detail-pages.02-upwrit.jpg" alt="" width="375" height="5075">
                            <img class="hidden sm:block w-full h-auto" loading="lazy" src="img/v2/ecommerce/lg/order-detail-pages.02-upwrit.jpg" alt="" width="1280" height="4120">
                        </div>
                    </section>
                    ...
                    <section aria-labelledby="heading-04740945117f4ec46b10f866630a6347">
                        <div class="flex flex-wrap md:flex-nowrap items-center mb-3 py-1.5 whitespace-nowrap">
                            <div class="min-w-0 flex items-center">
                                <h2 class="font-medium text-gray-900 truncate">
                                    <span class="mr-1">Simple with full order details</span>
                                </h2>
                                <span class="flex-none uppercase bg-gray-200 text-gray-600 text-xs tracking-wide font-semibold px-2 py-1 rounded-md ml-3">
                                    PNG Preview
                                </span>
